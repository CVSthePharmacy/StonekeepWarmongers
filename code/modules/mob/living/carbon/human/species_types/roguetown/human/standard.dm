...
/datum/species/human/northern/standard
	...
	OFFSET_CLOAK_F = list(0,0), OFFSET_FACEMASK_F = list(0,0), OFFSET_HEAD_F = list(0,-1), \
	...
	specstats = list("strength" = 2, "perception" = 1, "intelligence" = 0, "constitution" = 1, "endurance" = 3, "speed" = 2, "fortune" = 1)
	specstats_f = list("strength" = 2, "perception" = 1, "intelligence" = 0, "constitution" = 1, "endurance" = 3, "speed" = 2, "fortune" = 1)
