...
/obj/item/clothing/suit/roguetown/armor/armordress/ppr/jammies/fat
	slot_flags = ITEM_SLOT_ARMOR
	name = "jammies"
	desc = "A fine aristocratic uniform, perfect for the aspiring Warmonger. Only for those with a healthy rotundness."
	body_parts_covered = CHEST|ARMS|VITALS
	icon_state = "jammiesfat"
	icon = 'icons/roguetown/clothing/armor.dmi'
	allowed_sex = list("female", "male")
	mob_overlay_icon = 'icons/roguetown/clothing/onmob/armor.dmi'
	sleeved = 'icons/roguetown/clothing/onmob/helpers/sleeves_armor.dmi'
...
/obj/item/clothing/suit/roguetown/armor/armordress/ppr/jammies/bulky
	slot_flags = ITEM_SLOT_ARMOR
	name = "jammies"
	desc = "A fine aristocratic uniform, perfect for the aspiring Warmonger. Only for those with a healthy rotundness."
	body_parts_covered = CHEST|ARMS|VITALS
	icon_state = "jammiesbulky"
	icon = 'icons/roguetown/clothing/armor.dmi'
	allowed_sex = list("female", "male")
	mob_overlay_icon = 'icons/roguetown/clothing/onmob/armor.dmi'
	sleeved = 'icons/roguetown/clothing/onmob/helpers/sleeves_armor.dmi'
